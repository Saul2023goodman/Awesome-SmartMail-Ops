...
if(!js.includes("selectButton.hidden=!visible.length")) throw new Error('bulk confirmation selector should disappear when nothing actually needs confirmation');
...
if(!/\.nmda-review-core-fields textarea[\s\S]*?min-height:360px\s*!important/.test(css)) throw new Error('mail body edit area is still too small');
console.log('v1.19 auto-flow contract OK: deterministic repairs auto-resolve, completed checks auto-advance, editable mail dominates evidence');
