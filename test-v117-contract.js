...
if(js.includes('id="nmda-review-evidence-details"')) throw new Error('parsing evidence should not be rendered in the user review flow');
...
console.log('review contract OK: editable mail stays primary; parsing evidence stays out of the user review flow; scheduler remains default-open');
